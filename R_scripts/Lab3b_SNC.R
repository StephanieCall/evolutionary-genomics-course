# Data Carpentry "Data Manipulation using dplyr and tidyr" tutorial

# Import the packages in tidyverse
library("tidyverse")
...
# Also accidentally found that spread(measurement, -measurement) 
