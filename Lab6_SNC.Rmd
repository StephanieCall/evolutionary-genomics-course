...
```{r EX1_confirmed_fill, fig.height=6, fig.width=9}
# Read in the world map data
world <- as_tibble(map_data("world")) %>% 
  mutate(region = str_replace_all(region, c("USA" = "US", "Czech Republic" = "Czechia",  
